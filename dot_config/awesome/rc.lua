...
local default_theme_dir = "/home/skadic/.config/awesome/themes/default/"
local default_icons_dir = default_theme_dir .. "icons/"
...
beautiful.init("/home/skadic/.config/awesome/themes/catppuccin/theme.lua")
local nice = require("nice")
nice {
  titlebar_color = "#1A1826",
  close_color = beautiful.red,
  minimize_color = beautiful.yellow,
...
local mybattery = awful.widget.watch(
    ...
    function(widget, stdout)
        ...
        local bat_icons = { " ", " ", " ", " " }
        local bat_index = math.min(bat_now.percentage + 25, 100) / 25;

        -- customize here
        widget:set_text(bat_icons[bat_index] .. " " .. bat_now.percentage .. " " .. bat_now.state)
    end
)
...
globalkeys = gears.table.join(
  ...
  awful.key({}, "XF86MonBrightnessUp", function() awful.spawn("brightnessctl -d amdgpu_bl1 set +5%") end,
    { description = "monitor brightness up", group = "control" }),
  awful.key({}, "XF86MonBrightnessDown", function() awful.spawn("brightnessctl -d amdgpu_bl1 set 5%-") end,
    { description = "monitor brightness down", group = "control" }),
...
awful.rules.rules = {
  ...
  {
    rule_any = { class = { "MEGAsync", "obsidian" }},
    properties = {
...
awful.spawn.spawn("pkill pulseaudio")
awful.spawn.spawn("pkill pa-applet")
awful.spawn.spawn("pkill redshift")
awful.spawn.spawn("pkill redshift")

-- Start Applications
awful.spawn.with_shell("picom --experimental-backends -b -f")
awful.spawn.with_shell("conky -c /home/skadic/.conkyrc")
awful.spawn.single_instance("megasync")
awful.spawn.once("fcitx5")
awful.spawn.once("nm-applet")
awful.spawn.once("redshift")
awful.spawn.once("pulseaudio")
sleep(1)
awful.spawn.once("pa-applet")
awful.spawn.once("flameshot")
awful.spawn.spawn("feh --bg-fill /home/skadic/Pictures/bg/Konachan.com - 90390 remilia_scarlet touhou vampire.jpg")
